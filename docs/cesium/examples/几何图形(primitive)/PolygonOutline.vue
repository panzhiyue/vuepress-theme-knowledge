...
export default {
  ...
  mounted() {
    ...
    var geometry1 = Cesium.PolygonOutlineGeometry.createGeometry(polygon);
    ...
    var geometry2 =
      Cesium.PolygonOutlineGeometry.createGeometry(polygonWithHole);
    ...
    var geometry3 =
      Cesium.PolygonOutlineGeometry.createGeometry(extrudedPolygon);
