...
export default {
  ...
  mounted() {
    ...
    var rectangle1 = new Cesium.RectangleOutlineGeometry({
      ellipsoid: Cesium.Ellipsoid.WGS84,
      rectangle: Cesium.Rectangle.fromDegrees(-70.0, 39.0, -64.0, 42.0),
      height: 10000.0,
    });
    var geometry1 = Cesium.RectangleOutlineGeometry.createGeometry(rectangle1);

    // 2. create an extruded rectangle without a top
    var rectangle2 = new Cesium.RectangleOutlineGeometry({
      ellipsoid: Cesium.Ellipsoid.WGS84,
      rectangle: Cesium.Rectangle.fromDegrees(-80.0, 39.0, -74.0, 42.0),
      height: 10000.0,
      extrudedHeight: 300000,
    });
    var geometry2 = Cesium.RectangleOutlineGeometry.createGeometry(rectangle2);
