...
export default {
  ...
  mounted() {
    ...
    //红色面
    var redPolygon = _this.viewer.entities.add({
    ...
    var greenPolygon = _this.viewer.entities.add({
    ...
    var orangePolygon = _this.viewer.entities.add({
    ...
    var bluePolygon = _this.viewer.entities.add({
    ...
    var cyanPolygon = _this.viewer.entities.add({
    ...
    var purplePolygonUsingRhumbLines = _this.viewer.entities.add({
